...
describe('init function', () => {
  const testCases = [
    ...
    },
    {
      ...
      security:
        '{"consumer_key":"yis0TYCu7U9V4o7M","domain":"localhost","timestamp":"20140626-0528","signature":"e1eae0b86148df69173cb3b824275ea73c9c93967f7d17d6957fcdd299c8a4fe"}',
      request: '{"limit":100}',
      action: 'get',
    },
    {
      ...
      security:
        '{"consumer_key":"yis0TYCu7U9V4o7M","domain":"localhost","timestamp":"20140626-0528","signature":"18e5416041a13f95681f747222ca7bdaaebde057f4f222083881cd0ad6282c38"}',
      request: '{"limit":100}',
      action: 'post',
    },
    {
  ...
  describe('signature generation', () => {
    ...
    testCases.forEach((testCase) => {
      it(`should generate the expected signature for ${testCase.service} ${
        testCase.action ? testCase.action : ''
      }`, () => {
        ...
        switch (testCase.service) {
          case 'assess': // assess API puts the security signature in the questions API activity
            assert.strictEqual(
              output.questionsApiActivity.signature,
              testCase.signature
            );
            break;
